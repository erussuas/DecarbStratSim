...
EFFICIENCY_MEASURE_LIBRARY = [
    {
        ...
        "applies_to": "Electricity and natural gas",
        "typical_sites": "Office, warehouse, retail, healthcare, mixed facilities",
        "description": "Tune schedules, setpoints, economizers, ventilation rates, and controls to reduce heating/cooling waste.",
        "cost_profile": "Low to medium CAPEX",
        "impact_profile": "Moderate usage, cost, and emissions reduction where HVAC loads are material."
    },
    {
        "measure": "Lighting upgrades and controls",
        "applies_to": "Electricity",
        "typical_sites": "Office, warehouse, retail, manufacturing",
        "description": "LED retrofits, occupancy sensors, daylighting controls, and exterior lighting optimization.",
        "cost_profile": "Low to medium CAPEX",
        "impact_profile": "Electricity savings; strongest in large warehouses, offices, and retail portfolios."
    },
    {
        "measure": "Motors and variable frequency drives",
        "applies_to": "Electricity",
        "typical_sites": "Manufacturing, industrial, healthcare, large campuses",
        ...
        "impact_profile": "Meaningful electricity savings where motor loads are significant."
    },
    {
        "measure": "Compressed air optimization",
        "applies_to": "Electricity",
        "typical_sites": "Manufacturing and industrial facilities",
        "description": "Leak repair, pressure optimization, compressor sequencing, and equipment right-sizing.",
        "cost_profile": "Low to medium CAPEX",
        "impact_profile": "Can be a high-return measure in manufacturing sites with compressed air systems."
    },
    {
        "measure": "Refrigeration optimization",
        "applies_to": "Electricity",
        "typical_sites": "Cold storage, food logistics, grocery, pharma distribution",
        "description": "Optimize evaporators, condensers, defrost cycles, controls, door heaters, and temperature setpoints.",
        "cost_profile": "Medium CAPEX",
        "impact_profile": "High electricity-savings potential where refrigeration is a major load."
    },
    {
        "measure": "Boiler and thermal system efficiency",
        "applies_to": "Natural gas",
        "typical_sites": "Manufacturing, healthcare, campuses, large offices",
        "description": "Tune boilers, recover heat, improve steam traps, insulation, combustion efficiency, and distribution losses.",
        "cost_profile": "Low to medium CAPEX",
        "impact_profile": "Natural gas savings and Scope 1 emissions reduction."
    },
    {
        "measure": "Building management system optimization",
        "applies_to": "Electricity and natural gas",
        "typical_sites": "Office, healthcare, retail, warehouse, mixed campuses",
        "description": "Use BMS/BAS data to identify scheduling issues, simultaneous heating/cooling, overrides, and control drift.",
        "cost_profile": "Low CAPEX / operational improvement",
        "impact_profile": "Good first-wave measure where controls exist but are not optimized."
    },
]
...
if raw_df is not None and len(raw_df) > 0:
    ...
    with st.expander("What is included in the Energy Efficiency lever?", expanded=False):
        st.markdown(
            """
            The efficiency lever represents a bundle of common operational and capital measures. Actual applicability depends on
            site conditions, equipment, operating hours, controls maturity, and implementation constraints.
            """
        )
        st.dataframe(pd.DataFrame(EFFICIENCY_MEASURE_LIBRARY), use_container_width=True)
